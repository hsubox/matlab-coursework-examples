...
% 
% This function prepares the economic data and makes them available through
% global variables to all the routines that use them.
%
% INPUT Global Variables
% OUTPUT Globla Variables
...
Distillation_rental_cost_per_hour = 6000;   % Rental cost for crystallizer vessel, $ per hour of use
Crystallizer_rental_cost_per_hour = 5000;   % Rental cost for the dryer system, $ per hour of use
Dryer_rental_cost_per_hour = 3000;          % Rental cost for the
%
%   Materials prices
Materials_Prices(1) = 500;                  % price of reagent, A, $/kg
Materials_Prices(2) = 2000;                 % price of reagent, B, $/kg
Materials_Prices(3) = 20000;                % price of the product, P, $/kg
Materials_Prices(4) = 0;                    % price of the by-product, Q, $/kg
