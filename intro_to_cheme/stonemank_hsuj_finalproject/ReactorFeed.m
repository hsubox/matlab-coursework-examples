...
%
%   This function determines the composition and volume of the reacting
%   mixture, before the reaction starts.
%
...
%
%   Basic assumptions:
%   (a) Total Volume of Reactive Mixture = (Volume of Solvent,S1) + (Volume of A) + (Volume of B) + (Volume of C).
...
%   (e) Total Volume of Reacting Mixture = Capacity of the reactor vessel.
%       This requirement will maximize the amount of the desired product per batch.
%
...
%
%       Note: Requirement (d), above, implies the following relationship
%       between volume_A and volume_B:
...
%
%   Compute the amounts (in kilograms and moles) of all the materials in the
%   reactor feed.
%
...
%
Reactor_feed_kilograms(3) = 0;      % Reactor feed: Amount of P in kilograms.
Reactor_feed_kilograms(4) = 0;      % Reactor feed: Amount of Q in kilograms.
Reactor_feed_kilograms(5) = 0;      % Reactor feed: Amount of W in kilograms.
Reactor_feed_kilograms(6) = 0;      % Reactor feed: Amount of Z in kilograms.
Reactor_feed_kilograms(9) = 0;      % Reactor feed: Amount of Solvent, S2, in kilograms.
...
%
%   Set the temperature, total kilograms, and total volume of the reactor
%   feed.
Reactor_feed(10) = 298;     % in degrees, K.
Reactor_feed(11) = sum(Reactor_feed_kilograms); % The total mass of reactor feed in kilograms.
