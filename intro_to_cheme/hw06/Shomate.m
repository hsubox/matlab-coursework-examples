...
%     2) enthalpy in kJ/mol   (careful: kJ, not Joule!!)
%     3) entropy in J/mol K
%   Note, if T is a vector, outputs will all be vectors of the same shape.
...
%      Beware: There is another parameter "H" in NIST Webbook, which
%         is not needed for these calculations.
