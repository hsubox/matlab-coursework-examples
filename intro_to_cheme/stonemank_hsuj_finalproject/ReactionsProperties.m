...
% 
% This function assigns the values of various properties of the three reactions, 
% onto the elements of a matrix, and makes the matrix available to all other 
% functions as a GLOBAL variable.
% 
...
%     The second index signifies the specific property value of the corresponding
%     reaction, i.e.
...
% 
Reactions_Properties = zeros(3,3);
% Assign property values for the various reactions
% 
% Properties of the Main Reaction, Reaction 1
% 
% Estimate kinetic paraters for Reaction-1 through regression
parameters = KineticsRegression;                    % Use the "KineticsRegression" function to estimate the kinetic parameters
%
Reactions_Properties(1,1) = parameters(1,1);        % Estimate of the pre-exponential constant, in: (cm3)^2/(second, (moles)^2)
Reactions_Properties(1,2) = parameters(1,2)/1000;   % Estimate of the activation energy, in KJ/mole
Reactions_Properties(1,3) = 30;                     % in KJ/moles
%
% Properties of the First Side-Reaction, Reaction-2
%
Reactions_Properties(2,1) = 1000;                   % in (cm3)^2/(second, (moles)^2)
